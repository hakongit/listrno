...
export default function InsiderTradesError({
  error,
  reset,
}: {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        <h2 className="text-2xl font-bold mb-2">Kunne ikke laste innsidehandler</h2>
        <p className="text-gray-600 dark:text-gray-400 mb-6">
          Det oppstod en feil ved henting av innsidedata. Prøv igjen senere.
        </p>
